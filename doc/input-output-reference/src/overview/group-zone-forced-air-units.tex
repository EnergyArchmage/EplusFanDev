...
\paragraph{\texorpdfstring{Zone Ideal Loads Hybrid Ventilation Available Status {[]}}{Zone Ideal Loads Hybrid Ventilation Available Status }}\label{zone-ideal-loads-hybrid-ventilation-available-status}
...
\paragraph{\texorpdfstring{Fan Coil Runtime Fraction{[]}}{Fan Coil Runtime Fraction}}\label{fan-coil-runtime-fraction}
...
\paragraph{\texorpdfstring{Fan Coil Fan Speed Level {[]}}{Fan Coil Fan Speed Level }}\label{fan-coil-fan-speed-level}
...
\paragraph{\texorpdfstring{Fan Coil Part Load Ratio {[]}}{Fan Coil Part Load Ratio }}\label{fan-coil-part-load-ratio}
...
\paragraph{\texorpdfstring{Fan Coil Availability Status {[]}}{Fan Coil Availability Status }}\label{fan-coil-availability-status}
...
\paragraph{\texorpdfstring{Fan Coil Speed Ratio {[]}}{Fan Coil Speed Ratio }}\label{fan-coil-speed-ratio}
...
\paragraph{\texorpdfstring{Zone Unit Ventilator Fan Availability Status {[]}}{Zone Unit Ventilator Fan Availability Status }}\label{zone-unit-ventilator-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Unit Ventilator Fan Part Load Ratio {[]}}{Zone Unit Ventilator Fan Part Load Ratio }}\label{zone-unit-ventilator-fan-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Unit Heater Fan Availability Status {[]}}{Zone Unit Heater Fan Availability Status }}\label{zone-unit-heater-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Unit Heater Fan Part Load Ratio {[]}}{Zone Unit Heater Fan Part Load Ratio }}\label{zone-unit-heater-fan-part-load-ratio}
...
\paragraph{\texorpdfstring{Field: Design Supply Air Flow Rate {[}m\(^{3}\)/s{]}}{Field: Design Supply Air Flow Rate {[}m\^{}\{3\}/s{]}}}\label{field-design-supply-air-flow-rate-m3s}
...
\paragraph{\texorpdfstring{Zone Evaporative Cooler Unit Fan Speed Ratio {[]}}{Zone Evaporative Cooler Unit Fan Speed Ratio }}\label{zone-evaporative-cooler-unit-fan-speed-ratio}
...
\paragraph{\texorpdfstring{Zone Evaporative Cooler Unit Fan Availability Status {[]}}{Zone Evaporative Cooler Unit Fan Availability Status }}\label{zone-evaporative-cooler-unit-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Outdoor Air Unit Fan Availability Status {[]}}{Zone Outdoor Air Unit Fan Availability Status }}\label{zone-outdoor-air-unit-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Window Air Conditioner Fan Part Load Ratio {[]}}{Zone Window Air Conditioner Fan Part Load Ratio }}\label{zone-window-air-conditioner-fan-part-load-ratio}

This is the fan's part load ratio for the report timestep during which the fan had operated.

\paragraph{\texorpdfstring{Zone Window Air Conditioner Compressor Part Load Ratio {[]}}{Zone Window Air Conditioner Compressor Part Load Ratio }}\label{zone-window-air-conditioner-compressor-part-load-ratio}
...
\item
  Heating coil (Coil:Heating:Gas, Coil:Heating:Electric, Coil:Heating:Water, or Coil:Heating:Steam)
\item
  OutdoorAir:Mixer
\end{enumerate}
...
\paragraph{\texorpdfstring{Zone Packaged Terminal Air Conditioner Fan Part Load Ratio {[]}}{Zone Packaged Terminal Air Conditioner Fan Part Load Ratio }}\label{zone-packaged-terminal-air-conditioner-fan-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Packaged Terminal Air Conditioner Compressor Part Load Ratio {[]}}{Zone Packaged Terminal Air Conditioner Compressor Part Load Ratio }}\label{zone-packaged-terminal-air-conditioner-compressor-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Packaged Terminal Air Conditioner Fan Availability Status {[]}}{Zone Packaged Terminal Air Conditioner Fan Availability Status }}\label{zone-packaged-terminal-air-conditioner-fan-availability-status}
...
\item
  Supplemental heating coil (Coil:Heating:Gas or Coil:Heating:Electric)
\item
  OutdoorAir:Mixer
\end{enumerate}
...
\paragraph{\texorpdfstring{Zone Packaged Terminal Heat Pump Fan Part Load Ratio {[]}}{Zone Packaged Terminal Heat Pump Fan Part Load Ratio }}\label{zone-packaged-terminal-heat-pump-fan-part-load-ratio}

This output field is the part-load ratio of the fan. The fan part-load ratio is defined as the average supply air mass flow rate divided by the maximum supply air mass flow rate. The maximum supply air mass flow rate depends on whether heating, cooling, or no heating or cooling is required during the timestep. This value is calculated for each HVAC system timestep being simulated, and the results are averaged for the timestep being reported.

\paragraph{\texorpdfstring{Zone Packaged Terminal Heat Pump Compressor Part Load Ratio {[]}}{Zone Packaged Terminal Heat Pump Compressor Part Load Ratio }}\label{zone-packaged-terminal-heat-pump-compressor-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Packaged Terminal Heat Pump Fan Availability Status {[]}}{Zone Packaged Terminal Heat Pump Fan Availability Status }}\label{zone-packaged-terminal-heat-pump-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Water to Air Heat Pump Fan Part Load Ratio {[]}}{Zone Water to Air Heat Pump Fan Part Load Ratio }}\label{zone-water-to-air-heat-pump-fan-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Water to Air Heat Pump Compressor Part Load Ratio {[]}}{Zone Water to Air Heat Pump Compressor Part Load Ratio }}\label{zone-water-to-air-heat-pump-compressor-part-load-ratio}

This output field is the part-load ratio of the compressor used by the DX coils (cooling and heating). Compressor part-load ratio is defined as the total coil load divided by the coil steady-state capacity. This value is calculated for each HVAC system time step being simulated, and the results are averaged for the time step being reported.

\paragraph{\texorpdfstring{Zone Water to Air Heat Pump Fan Availability Status {[]}}{Zone Water to Air Heat Pump Fan Availability Status }}\label{zone-water-to-air-heat-pump-fan-availability-status}
...
\paragraph{\texorpdfstring{Zone Dehumidifier Part Load Ratio {[]}}{Zone Dehumidifier Part Load Ratio }}\label{zone-dehumidifier-part-load-ratio}
...
\paragraph{\texorpdfstring{Zone Dehumidifier Runtime Fraction {[]}}{Zone Dehumidifier Runtime Fraction }}\label{zone-dehumidifier-runtime-fraction}
...
\paragraph{\texorpdfstring{Zone Ventilator Supply Fan Availability Status {[]}}{Zone Ventilator Supply Fan Availability Status }}\label{zone-ventilator-supply-fan-availability-status}
...
This alpha field has two choices: \textbf{BlowThrough} or \textbf{DrawThrough}. If this field is left blank, the default is blow through.
...
\paragraph{Field: Outside Air Mixer Object Type}\label{field-outside-air-mixer-object-type}

This alpha field contains the identifying type of outside air mixer specified for the terminal unit. Outside air mixer type must be \textbf{OutsideAir:Mixer}. This field should be left blank when an outside air mixer is not simulated.

\paragraph{Field: Outside Air Mixer Object Name}\label{field-outside-air-mixer-object-name}
...
This choice field contains the identifying type of the terminal unit's DX cooling coil. The only valid DX cooling coil type is \textbf{Coil:Cooling:DX:VariableRefrigerantFlow}. This field should be left blank when a DX cooling coil is not simulated.
...
This choice field contains the identifying type of the terminal unit's DX heating coil. The only valid DX heating coil type is \textbf{Coil:Heating:DX:VariableRefrigerantFlow}. This field should be left blank when a DX heating coil is not simulated.
...
\paragraph{\texorpdfstring{Zone VRF Air Terminal Fan Availability Status {[]}}{Zone VRF Air Terminal Fan Availability Status }}\label{zone-vrf-air-terminal-fan-availability-status}
